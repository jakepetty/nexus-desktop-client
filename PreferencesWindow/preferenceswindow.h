...
private slots:
    ...
    void on_run_at_startup_toggled( bool checked )
    {
        if ( is_initialized ) {
    ...
    void on_startup_reminder_toggled( bool checked ){
        if ( is_initialized ) {
            qDebug() << "Saving on_startup_reminder_toggled";
            saveField( URL_EDIT_DESKTOPSETTING, "DesktopSetting", Acc->DesktopSetting["id"].toInt(),  "startup_reminder", checked );
        }
    }

    void on_allow_game_news_notifications_toggled( bool checked ){
        if ( is_initialized ) {
            qDebug() << "Saving on_allow_game_news_notifications_toggled";
            saveField( URL_EDIT_DESKTOPSETTING, "DesktopSetting", Acc->DesktopSetting["id"].toInt(),  "allow_game_news_notifications", checked );
        }
    }

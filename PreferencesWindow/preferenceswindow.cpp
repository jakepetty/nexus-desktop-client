...
void PreferencesWindow::loadData() {
    ...
    this->ui->startup_reminder->setChecked( Acc->DesktopSetting["startup_reminder"].toBool());
    this->ui->allow_game_news_notifications->setChecked( Acc->DesktopSetting["allow_game_news_notifications"].toBool());
    this->ui->run_at_startup->setChecked( Acc->DesktopSetting["run_at_startup"].toBool());
}

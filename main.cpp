...
int main( int argc, char * argv[] )
{
    ...
    if ( !Web->isAvailable( URL_BASE )) {
        ...
        if ( Acc->DesktopSetting["startup_reminder"].toBool()) {
            app->Tray->popup( "Nexus Desktop Client Reminder", "Our app sits in your system tray. Do not combine multiple queues/missions into one combat file. Upload your logs at the end of every queue/mission.", QSystemTrayIcon::Information );
        }
